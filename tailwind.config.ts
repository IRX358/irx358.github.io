  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "draw-line": "draw-line 2s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "typewriter": "typewriter 3s steps(40) forwards",
        "blink": "blink 1s cubic-bezier(0.4, 0, 0.2, 1) infinite",
        "float": "float 6s cubic-bezier(0.4, 0, 0.2, 1) infinite",
        "wiggle": "wiggle 0.3s cubic-bezier(0.4, 0, 0.2, 1) infinite",
        "marquee": "marquee 30s linear infinite",
        "highlight-sweep": "highlight-sweep 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "paper-plane": "paper-plane 1s cubic-bezier(0.4, 0, 0.2, 1) forwards",
        "glitch": "glitch 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
      },
